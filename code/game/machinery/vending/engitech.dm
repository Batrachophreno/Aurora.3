...
/obj/machinery/vending/encryption
	...
	products = list(
		...
		/obj/item/encryptionkey/heads/om = 1,
		/obj/item/encryptionkey/command = 5,
		/obj/item/encryptionkey/cargo = 5,
		/obj/item/encryptionkey/eng = 5,
		/obj/item/encryptionkey/med = 5,
		/obj/item/encryptionkey/sci = 5,
		/obj/item/encryptionkey/sec = 5,
		/obj/item/encryptionkey/service = 5,
		/obj/item/encryptionkey/warden = 5,
		/obj/item/encryptionkey/xenology = 5,
	)
