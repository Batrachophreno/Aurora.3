...
/obj/structure/machinery/door/airlock/mechanics_hints(mob/user, distance, is_adjacent)
	. += ..()
...
/obj/structure/machinery/door/airlock/antagonist_hints(mob/user, distance, is_adjacent)
	. += ..()
...
/obj/structure/machinery/door/airlock/feedback_hints(mob/user, distance, is_adjacent)
	. = ..()
	if(p_open)
...
/obj/structure/machinery/door/airlock/Initialize(mapload, dir, populate_components, obj/structure/door_assembly/assembly = null)
...
/obj/structure/machinery/door/airlock/Click(location, control, params)
	if(ishuman(usr))
...
/obj/structure/machinery/door/airlock/attack_generic(mob/user, damage, attack_message, environment_smash, armor_penetration, attack_flags, damage_type)
...
/obj/structure/machinery/door/airlock/external/khaki
	door_frame_color = "#ac8b78"

/obj/structure/machinery/door/airlock/external/merc
	door_frame_color = "#8b7d86"

/obj/structure/machinery/door/airlock/external/red
	door_frame_color = "#c24f4f"

/obj/structure/machinery/door/airlock/external/blue
	door_frame_color = "#6176a1"

/obj/structure/machinery/door/airlock/external/purple
...
/obj/structure/machinery/door/airlock/service // Service Airlock
	icon_state = "ser"
	paintable = AIRLOCK_PAINTABLE_MAIN
	door_color = "#6f8751"

/obj/structure/machinery/door/airlock/service/custodial // Custodial Airlock
	icon_state = "custodial"
	paintable = AIRLOCK_PAINTABLE_MAIN | AIRLOCK_PAINTABLE_STRIPE
	door_color = "#6f8751"
	stripe_color = COLOR_PURPLE_GRAY

/obj/structure/machinery/door/airlock/glass_service // Service Airlock (Glass)
...
/obj/structure/machinery/door/airlock/glass_service/custodial // Custodial Airlock (Glass)
...
/obj/structure/machinery/door/airlock/command/gold
	icon_state = "cmdgold"
	paintable = AIRLOCK_PAINTABLE_MAIN | AIRLOCK_PAINTABLE_STRIPE
	door_color = "#475057"
	stripe_color = "#ffc443"
...
/obj/structure/machinery/door/airlock/generic/maintenance/external//for connecting to the horizons hull, duh
	door_frame_color = "#81838b"//Meant to connect to external scc spaceship walls like the horizon hull
...
/obj/structure/machinery/door/airlock/centcom/attackby(obj/item/attacking_item, mob/user)
	if (operating)
		return TRUE
...
/obj/structure/machinery/door/airlock/centcom/attack_ai(mob/user)
	if(!ai_can_interact(user))
		return
	return attackby(null, user)

/obj/structure/machinery/door/airlock/centcom/add_damage(damage, damage_flags, damage_type, armor_penetration, obj/weapon, message)
	return	// No.

/obj/structure/machinery/door/airlock/centcom/emag_act()
	return NO_EMAG_ACT

/obj/structure/machinery/door/airlock/centcom/ex_act()
	return

/obj/structure/machinery/door/airlock/centcom/emp_act()
	. = ..()

	return

/obj/structure/machinery/door/airlock/glass_centcom
	opacity = FALSE
	glass = 1
	hashatch = FALSE
	hack_proof = TRUE
...
/obj/structure/machinery/door/airlock/glass_centcom/attackby(obj/item/attacking_item, mob/user)
	if (operating)
		return TRUE
...
/obj/structure/machinery/door/airlock/glass_centcom/attack_ai(mob/user)
	if(!ai_can_interact(user))
		return
	return attackby(null, user)

/obj/structure/machinery/door/airlock/glass_centcom/add_damage(damage, damage_flags, damage_type, armor_penetration, obj/weapon, message)
	return	// No.

/obj/structure/machinery/door/airlock/glass_centcom/emag_act()
	return NO_EMAG_ACT

/obj/structure/machinery/door/airlock/glass_centcom/ex_act()
	return

/obj/structure/machinery/door/airlock/glass_centcom/emp_act()
	. = ..()

	return

/obj/structure/machinery/door/airlock/proc/paint_airlock(paint_color)
	door_color = paint_color
	update_icon()

/obj/structure/machinery/door/airlock/proc/stripe_airlock(paint_color)
	stripe_color = paint_color
	update_icon()

/obj/structure/machinery/door/airlock/proc/paint_window(paint_color)
	if (paint_color)
...
/obj/structure/machinery/door/airlock/vault/bolted
	locked = TRUE
...
/obj/structure/machinery/door/airlock/khaki
	paintable = AIRLOCK_PAINTABLE_MAIN | AIRLOCK_PAINTABLE_STRIPE
	door_color = "#364664"
	stripe_color = "#ff4343"
	door_frame_color = "#8d8078"

/obj/structure/machinery/door/airlock/merc
	paintable = AIRLOCK_PAINTABLE_MAIN | AIRLOCK_PAINTABLE_STRIPE
	door_color = "#534663"
	stripe_color = "#fac826"
	door_frame_color = "#8b7d86"

/obj/structure/machinery/door/airlock/red
	paintable = AIRLOCK_PAINTABLE_MAIN
	door_color = "#364664"
	door_frame_color = "#c24f4f"

/obj/structure/machinery/door/airlock/purple
	paintable = AIRLOCK_PAINTABLE_MAIN
	door_color = "#596170"
	door_frame_color = "#7846b1"
...
/obj/structure/machinery/door/airlock/brown
	door_color = "#574b3d"
...
/obj/structure/machinery/door/airlock/diona
...
/obj/structure/machinery/door/airlock/phoron/proc/ignite(exposed_temperature)
	if(exposed_temperature > 300)
		PhoronBurn(exposed_temperature)

/obj/structure/machinery/door/airlock/phoron/proc/PhoronBurn(temperature)
...
/obj/structure/machinery/door/airlock/proc/isWireCut(var/wireIndex)
	// You can find the wires in the datum folder.
	return QDELETED(wires) ? FALSE : wires.is_cut(wireIndex)

/obj/structure/machinery/door/airlock/proc/canAIControl()
	return ((src.ai_control_disabled!=1) && (!src.isAllPowerLoss()));

/obj/structure/machinery/door/airlock/proc/canAIHack()
...
/obj/structure/machinery/door/airlock/proc/isAllPowerLoss()
	if(stat & (NOPOWER|BROKEN))
		return TRUE
...
/obj/structure/machinery/door/airlock/proc/mainPowerCablesCut()
	return src.isWireCut(WIRE_POWER1) || src.isWireCut(WIRE_POWER2)

/obj/structure/machinery/door/airlock/proc/backupPowerCablesCut()
...
/obj/structure/machinery/door/airlock/proc/set_idscan(var/activate, var/feedback = 0)
	var/message = ""
...
/obj/structure/machinery/door/airlock/proc/set_safeties(var/activate, var/feedback = 0)
	var/message = ""
...
/obj/structure/machinery/door/airlock/update_icon(var/state = 0)
	if (QDELING(src))
		return
...
/obj/structure/machinery/door/airlock/proc/set_airlock_overlays(state, force_compile)
...
/obj/structure/machinery/door/airlock/attack_ai(mob/user as mob)
	if(!ai_can_interact(user))
		return
	ui_interact(user)

/obj/structure/machinery/door/airlock/ui_interact(mob/user, var/datum/tgui/ui)
...
/obj/structure/machinery/door/airlock/proc/bolts_interact(var/mob/user, var/activate, var/isAdmin, var/antag)
...
/obj/structure/machinery/door/airlock/proc/bolts_override(var/mob/user, var/activate, var/isAdmin, var/antag)
...
/obj/structure/machinery/door/airlock/proc/open_interact(var/mob/user, var/activate)
	if(welded)
...
/obj/structure/machinery/door/airlock/proc/hack(mob/user as mob)
	if(src.ai_hacking==0)
		src.ai_hacking=1
		spawn(20)
...
/obj/structure/machinery/door/airlock/CanPass(atom/movable/mover, turf/target, height=0, air_group=0)
	if (src.isElectrified())
...
/obj/structure/machinery/door/airlock/proc/powerless_manual_override_procedure(var/mob/user, var/current_iteration = 0)
	current_iteration++
...
/obj/structure/machinery/door/airlock/proc/cut_bolts(var/obj/item/tool, var/mob/user)
	var/cut_delay = 200
	var/cut_verb
	var/cut_sound
	var/cutting = FALSE
...
/obj/structure/machinery/door/airlock/proc/cut_procedure(var/mob/user, var/cut_delay, var/cut_verb, var/cut_sound)
...
/obj/structure/machinery/door/airlock/CanUseTopic(var/mob/user)
...
/obj/structure/machinery/door/airlock/Topic(href, href_list)
	if(..())
		return 1
...
/obj/structure/machinery/door/airlock/proc/CreateAssembly()
...
/obj/structure/machinery/door/airlock/proc/CanChainsaw(var/obj/item/material/twohanded/chainsaw/ChainSawVar)
...
/obj/structure/machinery/door/airlock/phoron/attackby(obj/item/attacking_item, mob/user)
	if(attacking_item)
		ignite(is_hot(attacking_item))
	return ..()

/obj/structure/machinery/door/airlock/set_broken()
	src.p_open = TRUE
	stat |= BROKEN
...
/obj/structure/machinery/door/airlock/open(var/forced=0)
	...
	if(src.close_other != null && istype(src.close_other, /obj/structure/machinery/door/airlock/) && !src.close_other.density)
...
/obj/structure/machinery/door/airlock/can_open(var/forced=0)
	if(!forced)
...
/obj/structure/machinery/door/airlock/can_close(var/forced=0)
	if(locked || welded)
		return 0
	if(!forced)
...
/obj/structure/machinery/door/airlock/on_death(damage, damage_flags, damage_type, armor_penetration, obj/weapon)
	if(prob(50))
		open()
		scrapped = TRUE
	set_broken()
...
/obj/structure/machinery/door/blocks_airlock()
	return 0

/obj/structure/window/blocks_airlock()
	return 0

/obj/structure/machinery/mech_sensor/blocks_airlock()
	return 0
...
/obj/structure/machinery/portable_atmospherics/canister/airlock_crush(var/crush_damage)
	. = ..()
...
/obj/structure/machinery/door/airlock/proc/create_electronics()
...
/obj/structure/machinery/door/airlock/emp_act(var/severity)
	. = ..()
...
/obj/structure/machinery/door/airlock/power_change() //putting this is obj/structure/machinery/door itself makes non-airlock doors turn invisible for some reason
	..()
	if(stat & NOPOWER)
