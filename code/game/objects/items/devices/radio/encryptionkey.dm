...
/obj/item/encryptionkey
	...
	icon = 'icons/obj/item/encryptionkey.dmi'
...
/obj/item/encryptionkey/attackby(obj/item/attacking_item, mob/user)
	return

/obj/item/encryptionkey/ship
...
/obj/item/encryptionkey/ship/proc/get_sector_z()
	. = GET_Z(get_turf(src))

/obj/item/encryptionkey/ship/common
	use_common = TRUE

/obj/item/encryptionkey/ship/odyssey/get_sector_z()
	if(SSodyssey.scenario_zlevels && SSodyssey.scenario_zlevels.len)
		. = SSodyssey.scenario_zlevels[1]
	else // safe fallback
		. = GET_Z(get_turf(src))

/obj/item/encryptionkey/ship/coal_navy
...
/obj/item/encryptionkey/syndicate/antagonist_hints(mob/user, distance, is_adjacent)
	. += ..()
...
/obj/item/encryptionkey/hivenet
...
/obj/item/encryptionkey/heads/xo
...
/obj/item/encryptionkey/rev
	name = "standard encryption key"
	desc = "An encryption key for a radio headset. Contains cypherkeys."
	additional_channels = list(CHANNEL_RAIDER = TRUE)
	origin_tech = list(TECH_ILLEGAL = 2)

/obj/item/encryptionkey/rev/antagonist_hints(mob/user, distance, is_adjacent)
	. += ..()
...
/obj/item/storage/box/fancy/keypouch
	...
	storage_slots = 3
	can_hold = list(/obj/item/encryptionkey)
	starts_with = null
...
/obj/item/storage/box/fancy/keypouch/eng
	starts_with = list(/obj/item/encryptionkey/eng_spare = 3)

/obj/item/storage/box/fancy/keypouch/med
	starts_with = list(/obj/item/encryptionkey/med_spare = 3)

/obj/item/storage/box/fancy/keypouch/sec
	starts_with = list(/obj/item/encryptionkey/sec_spare = 3)

/obj/item/storage/box/fancy/keypouch/sci
	starts_with = list(/obj/item/encryptionkey/sci_spare = 3)

/obj/item/storage/box/fancy/keypouch/cargo
	starts_with = list(/obj/item/encryptionkey/cargo_spare = 3)

/obj/item/storage/box/fancy/keypouch/service
	starts_with = list(/obj/item/encryptionkey/service_spare = 3)
