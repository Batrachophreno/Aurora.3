...
// Reinforced wall construction states
#define INTACT 0
...
// Machine/computer frame (de/con)struction states
/// Machine frame is empty, no wires no board
#define FRAME_STATE_EMPTY 0
/// Machine frame has been wired
#define FRAME_STATE_WIRED 1
/// Machine frame has a board installed, it is safe to assume if in this state then circuit is non-null (but you never know)
#define FRAME_STATE_BOARD_INSTALLED 2

/// Computer frame is empty, no circuit board yet
#define FRAME_COMPUTER_STATE_EMPTY FRAME_STATE_EMPTY
/// Computer frame now has a board installed, it is safe to assume beyond this state, circuit is non-null (but you never know)
#define FRAME_COMPUTER_STATE_BOARD_INSTALLED 1
/// Computer frame has been secured
#define FRAME_COMPUTER_STATE_BOARD_SECURED 2
/// Computer frame has been wired
#define FRAME_COMPUTER_STATE_WIRED 3
/// Computer frame has had glass applied to it
