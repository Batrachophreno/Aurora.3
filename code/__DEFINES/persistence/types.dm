...
CREATE_PERSISTENT_TYPE_HISTORY(gas_storage, "Gas storage tank level", "Gas storage tank level in KPA for the given gas type", TRUE, /singleton/persistent_type_history_expiration_rule/round_count/ten)
